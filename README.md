...
### DI - Scrutinator
Scrutinator captures the `IServiceCollection` via `AddDIScrutinator()`, then analyzes it when the dashboard route is hit. The UI is an embedded HTML file that renders the serialized report.
